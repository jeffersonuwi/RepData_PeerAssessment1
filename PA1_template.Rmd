...
D. Make a histogram of the total number of steps taken each day and calculate and report the mean and median total number of steps taken per day. Let's check if these values differ from the estimates from the first part of the assignment? What would be the impact of imputing missing data on the estimates of the total daily number of steps?
